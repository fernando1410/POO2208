...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(204, 131, 204));
        ...
        panel2.setBackground(new Color(171, 204, 131));
        ...
        panel3.setBackground(new Color(131, 202, 204));

        //Panel 4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(204, 178, 131));
